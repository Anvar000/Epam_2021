...
You should create files required for the testing inside the
test run and remove them after the test run.
(Opposite to previous homeworks when you reused files
...
def read_magic_number(path: str) -> bool:
    """A function  gets file path as an argument.
Read the first line of the file.
If first line is a number return true if number in an interval [1, 3)*
and false otherwise.
In case of any error, a ValueError should be thrown.
    ...
    Raises:
        ValueError: File not found
                    ...
                    Exception in converting file

    Returns:
        bool: True - if the number is in interval [1;3]
              False - othercases.
    """
    try:
